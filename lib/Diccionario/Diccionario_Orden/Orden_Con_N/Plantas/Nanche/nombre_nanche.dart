...
class NombreNanchePage extends StatelessWidget {
  const NombreNanchePage({
    Key? key,
    required this.text,
  }) : super(key: key);
            ...
            children: [
              ...
              Card(
                ...
                child: Stack(
                  ...
                  children: [
                    Ink.image(
                      image: const AssetImage('lib/assets/M/nanche_1.jpg'),
                      fit: BoxFit.cover,
                      height: 250,
                    ),
                  ],
              ...
              RichText(
                text: TextSpan(
                  ...
                  children: const <TextSpan>[
                    TextSpan(
                        text: 'Byrsonima crassifolia',
                        style: TextStyle(
                          fontSize: 24,
                          fontStyle: FontStyle.italic,
                        )),
                    TextSpan(
                        text: ' (L.) Kth.', style: TextStyle(fontSize: 24)),
                  ],
                ),
              ),
              const SizedBox(
              ...
              Card(
                ...
                child: Stack(
                  ...
                  children: [
                    Ink.image(
                      image: const AssetImage('lib/assets/M/nanche_2.jpg'),
                      fit: BoxFit.cover,
                      height: 250,
                    ),
                  ],
              ...
              Card(
                ...
                child: Stack(
                  ...
                  children: [
                    Ink.image(
                      image: const AssetImage('lib/assets/M/nanche_3.jpg'),
                      fit: BoxFit.cover,
                      height: 250,
                    ),
                  ],
